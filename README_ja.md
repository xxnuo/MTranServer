...
Windows、Mac、Linuxのスタンドアロンクライアントソフトウェアバージョン: [MTranServerClient](https://github.com/xxnuo/MTranServerClient) (未公開、正式版公開前)

サーバーAPIのソースコードリポジトリ: [MTranServerCore](https://github.com/xxnuo/MTranServerCore) (未公開、正式版公開前)
