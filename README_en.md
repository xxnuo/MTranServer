...
| MTranServer (This Project)                                             | Low            | High        | Average             | Ultra Fast | 50ms average response time per request, 450MB memory usage after loading English-Chinese translation model                                                        |
